...
void test_1d_matrix(rtt_dsxx::UnitTest &ut) {
  ...
  // Test Single Material Matrix
  {
    ...
    Grey_P1_Matrix matrix(iface.control_data);
    ...
    for (auto &d : matrix.solver_data.diagonal)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(d, 17.8768, 1e-5));
...
void test_1d_dd_matrix(rtt_dsxx::UnitTest &ut) {
  ...
  // Test Single Material Matrix
  {
    ...
    if (rtt_c4::node() == 0)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][1], -11.2167, 1e-5));
    if (rtt_c4::node() == 1)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][0], -11.2167, 1e-5));
...
void test_2d_matrix(rtt_dsxx::UnitTest &ut) {
  ...
  // Test Single Material Matrix
  {
    ...
    // Check the matrix values
    for (auto &d : matrix.solver_data.diagonal)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(d, 29.0935, 1e-5));
    for (auto &b : matrix.solver_data.source)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(b, 9.29023, 1e-5));
    // Check connectivity vector
    ...
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][1], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][3], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][0], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][3], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][1], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][2], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][0], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][2], -11.2167, 1e-5));
  ...
  // Test Multi Material Matrix
  {
    ...
    // Check the matrix values
    for (auto &d : matrix.solver_data.diagonal)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(d, 20.3447, 1e-5));
    for (auto &b : matrix.solver_data.source)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(b, 21.2717, 1e-5));
    // Check connectivity vector
    FAIL_IF_NOT(matrix.solver_data.off_diagonal_id[0][0] == 4);
    ...
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][3],
                                     matrix.solver_data.off_diagonal[3][2]));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][1], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][3], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][0], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][3], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][1], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][2], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][0], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][2], -7.78318, 1e-5));
...
void test_2d_dd_matrix(rtt_dsxx::UnitTest &ut) {
  ...
  // Test Single Material Matrix
  {
    ...
    if (rtt_c4::node() == 2) {
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][1], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][2], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][0], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][2], -11.2167, 1e-5));
    }

    // Solve matrix using gauss siedel
    matrix.gs_solver(1.0e-7, 100, true);
    for (auto &e : matrix.solver_data.cell_eden)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(e, 1.39491, 1e-5));
...
void test_3d_matrix(rtt_dsxx::UnitTest &ut) {
  ...
  // Test Single Material Matrix
  {
    ...
    // Check the matrix values
    for (auto &d : matrix.solver_data.diagonal)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(d, 40.3102, 1e-5));
    for (auto &b : matrix.solver_data.source)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(b, 9.29023, 1e-5));
    // Check connectivity vector
    ...
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][1], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][3], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][5], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][0], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][3], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][5], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][1], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][2], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][5], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][0], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][2], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][5], -11.2167, 1e-5));

    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[4][1], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[4][3], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[4][4], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[5][0], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[5][3], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[5][4], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[6][1], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[6][2], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[6][4], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[7][0], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[7][2], -11.2167, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[7][4], -11.2167, 1e-5));
  ...
  // Test Multi Material Matrix
  {
    ...
    // Check the matrix values
    for (auto &d : matrix.solver_data.diagonal)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(d, 28.1279, 1e-5));
    for (auto &b : matrix.solver_data.source)
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(b, 21.2717, 1e-5));
    // Check connectivity vector
    FAIL_IF_NOT(matrix.solver_data.off_diagonal_id[0][0] == 8);
    ...
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][1], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][3], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][5], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][0], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][3], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][5], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][1], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][2], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][5], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][0], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][2], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][5], -7.78318, 1e-5));

    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[4][1], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[4][3], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[4][4], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[5][0], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[5][3], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[5][4], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[6][1], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[6][2], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[6][4], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[7][0], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[7][2], -7.78318, 1e-5));
    FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[7][4], -7.78318, 1e-5));
...
void test_3d_dd_matrix(rtt_dsxx::UnitTest &ut) {
  ...
  // Test Single Material Matrix
  {
    ...
    if (rtt_c4::node() == 1) {
      ...
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][3], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][5], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][1], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][2], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][5], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][0], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][2], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][5], -11.2167, 1e-5));
    }
    if (rtt_c4::node() == 2) {
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][1], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][3], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[0][4], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][0], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][3], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[1][4], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][1], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][2], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[2][4], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][0], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][2], -11.2167, 1e-5));
      FAIL_IF_NOT(rtt_dsxx::soft_equiv(matrix.solver_data.off_diagonal[3][4], -11.2167, 1e-5));
    }
