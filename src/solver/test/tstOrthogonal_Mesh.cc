...
void test_2d_dd_mesh(rtt_dsxx::UnitTest &ut) {
  Interface_Data iface;
  const bool dd = true;
  ...
  FAIL_IF_NOT(mesh.domain_decomposed());
  // Check cell data
  if (rtt_c4::node() == 0) {
    FAIL_IF_NOT(mesh.number_of_local_cells() == 1);
    // Cell 0
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 0);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(0) == 1);
    FAIL_IF_NOT(mesh.ghost_cell_proc(0) == 1);
    face = 2;
    FAIL_IF_NOT(soft_equiv(mesh.face_area(cell, face), 0.5));
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::BOUNDARY_FACE);
    face = 3;
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 1);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(1) == 2);
    FAIL_IF_NOT(mesh.ghost_cell_proc(1) == 2);
  }
  ...
  if (rtt_c4::node() == 1) {
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 0);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(0) == 0);
    FAIL_IF_NOT(mesh.ghost_cell_proc(0) == 0);
    face = 1;
    FAIL_IF_NOT(soft_equiv(mesh.face_area(cell, face), 0.5));
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::BOUNDARY_FACE);
    face = 2;
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 1);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(1) == 3);
    FAIL_IF_NOT(mesh.ghost_cell_proc(1) == 2);
  }
  ...
  if (rtt_c4::node() == 2) {
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 1);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(1) == 1);
    FAIL_IF_NOT(mesh.ghost_cell_proc(1) == 1);
    face = 3;
    FAIL_IF_NOT(soft_equiv(mesh.face_area(cell, face), 0.5));
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::BOUNDARY_FACE);
  }
...
void test_3d_dd_mesh(rtt_dsxx::UnitTest &ut) {
  Interface_Data iface;
  bool dd = true;
  ...
  if (rtt_c4::node() == 0) {
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 2);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(2) == 4);
    FAIL_IF_NOT(mesh.ghost_cell_proc(2) == 2);
  }
  ...
  if (rtt_c4::node() == 1) {
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 1);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(1) == 5);
    FAIL_IF_NOT(mesh.ghost_cell_proc(1) == 2);
  }
  ...
  if (rtt_c4::node() == 1) {
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 2);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(2) == 6);
    FAIL_IF_NOT(mesh.ghost_cell_proc(2) == 2);
  }
  ...
  if (rtt_c4::node() == 1) {
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 3);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(3) == 7);
    FAIL_IF_NOT(mesh.ghost_cell_proc(3) == 2);
  }
  ...
  if (rtt_c4::node() == 2) {
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 2);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(2) == 2);
    FAIL_IF_NOT(mesh.ghost_cell_proc(2) == 1);
    face = 5;
    FAIL_IF_NOT(soft_equiv(mesh.face_area(cell, face), 0.25));
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::BOUNDARY_FACE);
  }
  ...
  if (rtt_c4::node() == 2) {
    ...
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::GHOST_FACE);
    FAIL_IF_NOT(mesh.next_cell(cell, face) == 3);
    FAIL_IF_NOT(mesh.ghost_cell_global_id(3) == 3);
    FAIL_IF_NOT(mesh.ghost_cell_proc(3) == 1);
    face = 5;
    FAIL_IF_NOT(soft_equiv(mesh.face_area(cell, face), 0.25));
    FAIL_IF_NOT(mesh.face_type(cell, face) == odd_solver::FACE_TYPE::BOUNDARY_FACE);
  }
