//--------------------------------------------*-C++-*---------------------------------------------//
/*!
 * \file   solver/MG_Matrix.hh
 * \author Mathew Cleveland
 * \brief  Define class MG_Matrix
 * \note   Copyright (C) 2022 Triad National Security, LLC., All rights reserved.
 */
//------------------------------------------------------------------------------------------------//

#ifndef odd_solver_MG_Matrix_hh
#define odd_solver_MG_Matrix_hh
...
public:
  ...
  MG_Matrix(const Control_Data &control_data, const bool flux_limiter = false);
...
#endif // odd_solver_MG_Matrix_hh

//------------------------------------------------------------------------------------------------//
// end of solver/MG_Matrix.hh
//------------------------------------------------------------------------------------------------//
